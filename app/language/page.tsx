...
export default function LanguagePage() {
  const service = servicePages.language;
    ...
    <main className="min-h-screen bg-cream text-charcoal">
      ...
      <section className="py-20 sm:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:px-10">
          <aside className="rounded-[2rem] bg-plum p-7 text-cream">
            ...
            <p className="mt-3 leading-7 text-cream/70">{service.input}</p>
            <h2 className="mt-8 text-3xl font-black">Outputs</h2>
            <p className="mt-3 leading-7 text-cream/70">{service.output}</p>
          </aside>
